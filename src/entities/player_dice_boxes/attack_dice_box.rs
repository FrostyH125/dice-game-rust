...
use raylib::{color::Color, math::{Rectangle, Vector2}, prelude::{RaylibDraw, RaylibDrawHandle}, texture::Texture2D};

use crate::entities::{dice::Dice, dice_box_data::{DiceBoxData, DiceBoxState}};
...
impl AttackDiceBox {
    pub fn new() -> Self {
        ...
        AttackDiceBox {
            data: DiceBoxData::new(pos, Rectangle {
                x: pos.x + 2.0,
                y: pos.y - 63.0,
                width: 48.0,
                height: 64.0,
