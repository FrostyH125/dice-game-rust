...
use crate::{entities::{dice::Dice, dice_box_data::DiceBoxData, enemy_dice_boxes::snake_eyes::SnakeEyes, hand::Hand, player_dice_boxes::broadsword_box::BroadSwordBox}, system::input_handler::InputState};
...
impl DiceBox {
    ...
    pub fn update_for_player(&mut self, is_player_dragging_dice: &mut bool, was_player_dragging_dice: bool, hand: &mut Hand, input_state: &InputState, dt: f32) {
        let data = self.get_mut_data();
        
        data.pull_in_dragged_dice(&mut hand.dice);
        data.handle_dragging_dice(is_player_dragging_dice, hand, input_state, dt);
