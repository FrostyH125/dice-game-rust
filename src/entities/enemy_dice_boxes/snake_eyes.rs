...
use crate::entities::{dice::{DICE_WIDTH_HEIGHT, Dice}, dice_box_data::DiceBoxData, enemies::snake::Snake};
...
impl SnakeEyes {
    pub fn new(pos: Vector2) -> Self {
        SnakeEyes { data: DiceBoxData::new(pos, Rectangle { x: pos.x + 2.0, y: pos.y - DICE_WIDTH_HEIGHT, width: DICE_WIDTH_HEIGHT * 2.0, height: DICE_WIDTH_HEIGHT }) }
    }
